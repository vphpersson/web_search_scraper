...
export const CONFIG = {
    sources: {
         google: {
             ...
             get_base_url: async (browser, search_operators_map, search_query = '', search_param_entries = []) => {
                 ...
                 search_param_entries.forEach(([key, value]) => url.searchParams.set(key, value));
